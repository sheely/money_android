...
public class ThreadExecutorsHelper {
    ...
    public static ScheduledFuture<?> scheduleWithFixedDelay(Runnable runnable, long initialDelay,
        ...
        init();
        ScheduledFuture<?> future = scheduledExecutorService.scheduleWithFixedDelay(runnable,
    ...
    public static ScheduledFuture<?> scheduleAtFixedRate(Runnable runnable, long initialDelay,
        ...
        init();
        ScheduledFuture<?> future = scheduledExecutorService.scheduleAtFixedRate(runnable,
