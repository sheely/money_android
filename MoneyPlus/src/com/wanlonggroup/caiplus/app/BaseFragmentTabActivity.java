...
public class BaseFragmentTabActivity extends BaseActivity {
	...
	private static final String LOG_TAG = BaseFragmentTabActivity.class
			.getSimpleName();
	...
	public void addTab(String title,int icon, int indicatorView, Class<?> clss,
			Bundle args) {
		if (title == null) {
		...
		mTabManager.addTab(
				mTabHost.newTabSpec(title).setIndicator(
						new TabIndicator(this, title, icon, indicatorView)
	...
	public static class TabManager implements TabHost.OnTabChangeListener {
		private final BaseFragmentTabActivity mActivity;
		...
		public TabManager(BaseFragmentTabActivity activity, TabHost tabHost,
				int containerId) {
			mActivity = activity;
			mTabHost = tabHost;
