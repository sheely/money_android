...
public class AccountService {
	...
	public void update(DSObject userProfile) {
		String id = id();
		if (userProfile != null) {
			prefs.edit().putString("name", userProfile.getString("name")).putString("userId",
				userProfile.getString("userId")).putString("headIcon", userProfile.getString("headIcon")).putString(
				"password", userProfile.getString("password")).commit();
		}
		if (!id.equals(id())) {
